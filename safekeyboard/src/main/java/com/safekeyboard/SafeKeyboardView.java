...
public class SafeKeyboardView extends KeyboardView {
    ...
    private void init(Context context) {
        ...
        // 默认三种图标
        this.delDrawable = context.getDrawable(R.drawable.keyboard_delete);
        this.lowDrawable = context.getDrawable(R.drawable.keyboard_little);
        this.upDrawable = context.getDrawable(R.drawable.keyboard_large);
        this.upDrawableLock = context.getDrawable(R.drawable.keyboard_large_node);
...
//            Log.d("onDraw","error-"+e.getMessage());
        }
    }
...
//        boolean isNight = NightModeHelper.getInstance(getContext()).isNightMode();
//        int color = Color.parseColor(isNight?"#333333":"#000000");
        int color = Color.parseColor("#333333");
        drawKeyBackground(R.drawable.keyboard_change_white, canvas, key);
